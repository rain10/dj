...
//            _.extend(headers, {
//        "Origin": "http://127.0.0.1:8087/common/upload",
...
//                            	console.log(response.result);
                                img = $('<img src="'+response.result.data[0].url+'">');
                                $wrap.empty().append( img );
                            } else {
                                $wrap.text("预览出错");
                            }
...
//          alert(WebUploader.File.name);  
          if(fileid){  
         //获取数据  
         $.post('/app/content/load_news_img?id='+fileid,function(json){ 
        	 if(json.data==null) {
        		 return;
        	 }
        	 console.log(json)
...
//            var src=getRootPath()+'/download/fileDownLoadAction!showFile.action?fileName='+file.filename; 
            img = $('<img src="'+file.url+'" style="height:100%;">');  
