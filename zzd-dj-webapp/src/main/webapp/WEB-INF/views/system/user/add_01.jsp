	               ...
	               <input type="hidden" id="uid" value="${sysUser.id }">
                    ...
                    <div class="form-item">
                     ...
                     <div class="form-item">
                        ...
                        <input id="orgid" class="easyui-combotree" style="width: 90%;height: 30px;" value="${sysUser.orgid }"  data-options="editable:false,panelHeight:null" name="orgid" readonly=true>
