...
<div id="index">
    ...
    <div class="index-l">
		     ...
		     <div class="form-item" style="margin-top: 0.5%">
			       ...
			       <input type="text" class="easyui-textbox" id="realname" data-options="min:0,precision:2"/>
...
<!--                         </select> -->
					<input id="uenable" class="easyui-combobox" name="dept"   
					    data-options="valueField:'id',textField:'text',url:'${pageContent.request.contentPath}/system/dictionary/load_enabled2.do'" value="1"/>  


		      		<a id="usearch" href="javascript:void(0)" class="easyui-linkbutton" data-options="plain:true">搜索</a>
		      </div>
	      <div style="margin-top: 0.5%">
	      	 <a href="javascript:void(0)" onclick="addWin('/system/user/add_01')" data-options="iconCls:'fa fa-area-chart'" id="uadd" class="easyui-linkbutton primary" style="height: 32px;border-left-width: 1px;margin-left: 29px;">新增</a>
       		  <a href="javascript:void(0)" onclick="editWin('udg','/system/user/edit_01')" id="uedit" class="easyui-linkbutton error" data-options="iconCls:'fa fa-gears'">修改</a>
       		  <a href="javascript:void(0)" onclick="refresh('udg')" id="ubreak" class="easyui-linkbutton success" data-options="iconCls:'fa fa-desktop'">刷新</a>
	      </div>
	      </div>
...
jQuery('#udg').datagrid({
    url: '${pageContent.request.contentPath}/system/user/load_datagrid.do?type=1',
	...
	$("#usearch").click(function() {
		  ...
		  var enable = $("#uenable").combobox('getValue');
		  $('#udg').datagrid('load', {    
			  username: username,    
 			  enable:enable,
			  realname:realname,
